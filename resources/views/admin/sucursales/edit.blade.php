...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong>Editar sucursal {{ $sucursal->nombre }}</strong>
        </li>
    </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="element-box">
                {!! Form::model($sucursal, ['route' => ['admin.sucursales.update', $sucursal], 'method' => 'PUT', 'accept-charset' => 'UTF-8', 'enctype' => 'multipart/form-data','onsubmit' => "wait.modal('show')"]) !!}
