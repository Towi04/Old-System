...
@section('titulo')
    Reporte de asistencias de personal {{ date('Y') }}
@endsection
...
@section('breadcrumb')
    <ol class="breadcrumb no_print">
        ...
        <li class="breadcrumb-item active">
            <strong>Reporte asistencias del personal</strong>
        </li>
    </ol>
@endsection
                    ...
                    <div class="row">
                        ...
                        @if (request('tipo','dia') == 'dia')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo' => 'dia','fecha'=>$fecha_antes->format('d-m-Y') ]) }}"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo'=>'dia','fecha' => $fecha_despues->format('d-m-Y') ]) }}"
                        ...
                        @if (request('tipo','dia') == 'mes')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo'=>'mes','fecha'=> $fecha_antes->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo' => 'mes','fecha' => $fecha_despues->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip" data-title="{{ $fecha_despues->format('d \d\e F \d\e\l Y') }}"
                                    data-placement="top" class="btn btn-primary btn-sm text-white no_print"><i
                                        class="fas fa-arrow-alt-circle-right fa-2x"></i></a>
                            </div>
                        ...
                        @if (request('tipo','dia') == 'semanal')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo' => 'semanal','fecha' => $fecha_antes->startOfWeek()->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip"
                                    data-title="{{ $fecha_antes->format('d \d\e F  \d\e\l  Y') }}"
                                    data-placement="top"
                                    class="btn btn-primary btn-sm text-white no_print">
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo'=> 'semanal','fecha'=>$fecha_despues->startOfWeek()->format('d-m-Y')]) }}"
                                    data-toggle="tooltip" data-title="{{ $fecha_despues->format('d \d\e F \d\e\l Y') }}"
                                    data-placement="top" class="btn btn-primary btn-sm text-white no_print"><i
                                        class="fas fa-arrow-alt-circle-right fa-2x"></i></a>
                            </div>
                        ...
                        @if (request('tipo','dia') == 'anual')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo' => 'anual','fecha'=> $fecha_antes->format('d-m-Y'), ]) }}"
                                    data-toggle="tooltip"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.asistencias_personal',['tipo'=>'anual','fecha'=> $fecha_despues->format('d-m-Y') ]) }}"
                        ...
                        <div class="os-tabs-w">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm table-hover tb-pagos" id="tabla_abonos">
                                            ...
                                            <tbody>
                                                @foreach ($asistencias->get() as $asistencia)
                                                    <tr id="asistencia-{{ $asistencia->id }}">
                                                        <td class="text-primary text-center">
                                                            {{$asistencia->personal->fullname}}
                                                        </td>

                                                        <td class="text-nowrap" data-order="{{$asistencia->fecha->format('Ymdhia')}}">
                                                          
                                                                {{ $asistencia->fecha->format('d-m-Y h:i a') }}
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#datepicker').on('changeDate', function() {
                window.location = "{{route('reportes.asistencias_personal')}}?tipo={{$tipo}}&fecha="+$('#datepicker').datepicker('getFormattedDate')+"&forma_pago={{@$_GET['forma_pago']}}"
            });
