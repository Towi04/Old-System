...
@section('breadcrumb')
    <ol class="breadcrumb no_print">
        ...
        <li class="breadcrumb-item active">
            <strong>Reporte de inscritos</strong>
        </li>
    </ol>
@endsection
    ...
    <div class="row ">
        <div class="col-lg-12 no_print">
            ...
            <form action="" class="form-inline mt-3">
                {!! Form::label('id_asesor', 'Filtra por asesor: ') !!}&nbsp;
                {!! Form::select('id_asesor', $asesores, @$_GET['id_asesor'], ['id'=>'select_asesores', 'class'=>'form-control ']) !!}
                &nbsp;
                    ...
                    <div class="row">
                        ...
                        @if (request('tipo','dia') == 'dia')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo' => 'dia','fecha'=>$fecha_antes->format('d-m-Y') ]) }}"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo'=>'dia','fecha' => $fecha_despues->format('d-m-Y') ]) }}"
                        ...
                        @if (request('tipo','dia') == 'mes')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo'=>'mes','fecha'=> $fecha_antes->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo' => 'mes','fecha' => $fecha_despues->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip" data-title="{{ $fecha_despues->format('d \d\e F \d\e\l Y') }}"
                                    data-placement="top" class="btn btn-primary btn-sm text-white no_print"><i
                                        class="fas fa-arrow-alt-circle-right fa-2x"></i></a>
                            </div>
                        ...
                        @if (request('tipo','dia') == 'semanal')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo' => 'semanal','fecha' => $fecha_antes->startOfWeek()->format('d-m-Y') ]) }}"
                                    data-toggle="tooltip"
                                    data-title="{{ $fecha_antes->format('d \d\e F  \d\e\l  Y') }}"
                                    data-placement="top"
                                    class="btn btn-primary btn-sm text-white no_print">
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo'=> 'semanal','fecha'=>$fecha_despues->startOfWeek()->format('d-m-Y')]) }}"
                                    data-toggle="tooltip" data-title="{{ $fecha_despues->format('d \d\e F \d\e\l Y') }}"
                                    data-placement="top" class="btn btn-primary btn-sm text-white no_print"><i
                                        class="fas fa-arrow-alt-circle-right fa-2x"></i></a>
                            </div>
                        ...
                        @if (request('tipo','dia') == 'anual')
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo' => 'anual','fecha'=> $fecha_antes->format('d-m-Y'), ]) }}"
                                    data-toggle="tooltip"
                            ...
                            <div class="col-1 col-xxl-1 col-xl-1 col-md-1 col-sm-1">
                                <a href="{{ route('reportes.inscritos',['tipo'=>'anual','fecha'=> $fecha_despues->format('d-m-Y') ]) }}"
                                                ...
                                                @foreach ($inscritos as $inscrito)
                                                    <tr >
                                                        <td class="text-primary text-center">
                                                                <a target="_blank" href="{{route('alumnos.show', $inscrito->id_alumno)}}">{{ $inscrito->alumno->numero_control_fullname }}</a>
                                                        </td>

                                                        {{-- FECHA DEL ABONO --}}
                                                        <td class="text-nowrap">
                                                            <a target="_blank" href="{{route('grupos.show', $inscrito->id_grupo)}}">{{ $inscrito->grupo->nombre }}</a>
                                                        </td>
        ...
        <div class="col-lg-2 mb-3 no_print">
            ...
            <div class="col-sm-12 col-xxxl-12 p-1">
                <a class="element-box el-tablo p-3 text-center" href="#">
                  ...
                  <div class="value" >
                    <span id="span_abonos_monto">{{ number_format($inscritos->count(), 0, '.', ',') }}</span>
                  </div>
                </a>
            </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#datepicker').on('changeDate', function() {
                window.location = "{{route('reportes.inscritos')}}?tipo={{$tipo}}&fecha="+$('#datepicker').datepicker('getFormattedDate')+"&forma_pago={{@$_GET['forma_pago']}}"
            });
