    ...
    <div class="wrapper wrapper-content">
            ...
            <div class="col-lg-4">
                <div class="widget-holder widget-full-height widget-flex ">
                    <div class="widget-heading">
                        ...
                        <div class="widget-holder widget-full-height widget-flex-tools">
            ...
            <div class="col-lg-4">
                <div class="widget-holder widget-full-height widget-flex ">
                    ...
                    <div class="widget-body widget-holder widget-full-height widget-flex-heading">
                        <h3>You have meeting today!</h3>
                        <small><i class="fa fa-map-marker"></i> Meeting is on 6:00am. Check your schedule to see detail.</small>
                    </div>
                    <div class="widget-body inspinia-timeline">
