...
<body class="md-skin fixed-sidebar ">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li style="padding: 20px">
                    <span class="m-r-sm text-white">Bienvenido {{Auth::user()->nombres}}.</span>
                </li>
            ...
            <div class="footer">
                ...
                <div>
                    <strong>Todos los derechos reservados</strong> &copy; {{date('Y')}}
                </div>
            </div>
        </div>
    ...
    <script src="{{asset('js/plugins/bootstrap-timepicker/bootstrap-timepicker.js')}}"></script>
     <!-- Color picker -->
