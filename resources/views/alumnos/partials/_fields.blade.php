        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('fecha_nacimiento', null, ['class' => 'form-control', 'placeholder' => 'Escribe la fecha de nacimiento','title' => 'Fecha de nacimiento','autocomplete' => 'off','required' => true]); !!}
                </div>
            </div>
        </div>
    </fieldset>
