    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::date('fecha_inicio', null, ['class' => 'form-control', 'placeholder' => 'Escribe la fecha de inicio','required' => true,'min'=>\Carbon\Carbon::today()->subMonths(2)->format('Y-m-d'), 'max'=>\Carbon\Carbon::today()->addMonths(2)->format('Y-m-d') ]); !!}
            </div>
        </div>
