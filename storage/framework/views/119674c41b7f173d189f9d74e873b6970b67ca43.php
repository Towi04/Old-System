...
<head>
    ...
    <link href="<?php echo e(asset('template-kineticpro-horizontal/assets/vendors/material-icons/material-icons.css')); ?>"
        rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('template-kineticpro-horizontal/assets/vendors/mono-social-icons/monosocialiconsfont.css')); ?>"
        rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('template-kineticpro-horizontal/assets/vendors/feather-icons/feather.css')); ?>" rel="stylesheet"
        type="text/css">
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/jquery-toast-plugin/1.3.2/jquery.toast.min.css" rel="stylesheet"
        type="text/css">
    <link href="<?php echo e(asset('template-kineticpro-horizontal/assets/css/style.css')); ?>" rel="stylesheet" type="text/css">
    <!-- Head Libs -->
...
<body class="body-bg-full profile-page">
        ...
        <div class="row container-min-full-height">
            <div
                ...
                <div class="login-content px-3 w-75 text-center">
                    <img src="<?php echo e(asset('img/logo-negativo.png')); ?>">
                </div>
            </div>
                    ...
                    <form class="text-center" method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group no-gutters mb-5 text-center">
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" id="to-recover" class="text-muted fw-700 text-uppercase heading-font-family fs-12">
    ...
    <script src="<?php echo e(asset('template-kineticpro-horizontal/assets/js/material-design.js')); ?>"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-toast-plugin/1.3.2/jquery.toast.min.js"></script>

</body>

</html>
<?php /**PATH /Users/aldo/Sites/cncm/resources/views/auth/template-clean-admin/login.blade.php ENDPATH**/ ?>